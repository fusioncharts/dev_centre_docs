{
    ...
    events: {
        "beforeRender": function(evt, args) {
            ...
            controls.innerHTML = '<button style="background-color: #6957da; border: none; color: white; padding: 10px 25px; text-align: center; cursor: pointer; outline: none; text-decoration: none; display: inline-block; font-size: 16px;" onClick="updateData()" >Update chart data</button>';
