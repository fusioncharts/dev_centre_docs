{
  ...
  id : "sample-chart-4",//id of the chart - required to refer to the chart
  ...
  dataSource: {
    ...
    "beforeRender": function(evt, args) {
          var btn = document.createElement('input'),
              resize = document.createElement('input'),
              border = document.createElement('input'),
          ...
          resize.setAttribute("class", "btn");          
          
          border.setAttribute("type","button");
          border.setAttribute("value","CHANGE CHART BORDER");           
          border.setAttribute("class", "btn");  
          ...
          btn.onclick = function(){
              var chartObj = FusionCharts("sample-chart-4");
              var chartData = chartObj.getJSONData()['data'];
              p.innerHTML = JSON.stringify(chartData);
          };
          resize.onclick = function(){
              var chartId = "sample-chart-4";
              FusionCharts(chartId).resizeTo(200,200);
          };
          border.onclick = function(){
              var chartId = "sample-chart-4";
              FusionCharts(chartId).setChartAttribute({"borderColor": "#990000"}); 
          };
        }
    }
}
