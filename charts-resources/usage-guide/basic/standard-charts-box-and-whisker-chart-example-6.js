{
    ...
    dataSource: {
        "chart": {
            ...
            //transparency of the upper qhisker set to 70
            "upperWhiskerAlpha": "70",
            //color of the lower whisker set to green
            "lowerWhiskerColor": "0fff00",
            //thickness of the lower whisker set to 5
            "lowerWhiskerThickness": "5",
            //transparency of the lower whisker set to 70
            "lowerWhiskerAlpha": "70",
            //sets the width of the whisker with respect to the box plot
