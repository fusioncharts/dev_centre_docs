...
**Ascending order** - When you sort one or more columns in the data table in ascending order, the data will be arranged from the lowest to the highest values. This is the default sort in FusionTime.
...
**Comparator function** - When you use a JavaScript comparator function, it defines the sort order. If this function is omitted, the array is sorted according to the Unicode point value of the character.
...
var sortQuery = sort((a, b) => a[1] - b[1])
