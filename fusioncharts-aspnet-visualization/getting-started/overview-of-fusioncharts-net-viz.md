...
heading: Overview
formPresent: bottom
formDescription: 2. To download FusionCharts.NET locally fill up the form and click the download button.
---
...
1. To directly install NuGet package, run the following command in the NuGet Package Manage Console:
