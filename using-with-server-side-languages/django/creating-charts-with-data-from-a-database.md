...
* <a href="/using-with-server-side-languages/django/creating-charts-with-data-from-a-database.html#creating-a-simple-column-chart">Create a simple column chart</a>
* <a href="/using-with-server-side-languages/django/creating-charts-with-data-from-a-database.html#creating-a-drill-down-chart">Create a drill-down chart</a>
