...
{% embed_chart {"source": "using-with-server-side-languages-java-different-ways-of-loading-data-example-1.js", "id": "1"} %}
...
{% embed_chart {"source": "using-with-server-side-languages-java-different-ways-of-loading-data-example-2.js", "id": "2"} %}
...
{% embed_chart {"source": "using-with-server-side-languages-java-different-ways-of-loading-data-example-3.js", "id": "3"} %}
...
{% embed_chart {"source": "using-with-server-side-languages-java-different-ways-of-loading-data-example-4.js", "id": "4"} %}
