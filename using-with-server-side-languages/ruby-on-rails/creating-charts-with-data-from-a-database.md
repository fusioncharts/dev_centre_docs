...
>  Before you proceed, make sure you have [installed and set up the plugin]({% site.baseurl %}/using-with-server-side-languages/ruby-on-rails/introduction "@@open-newtab") correctly. </p>
