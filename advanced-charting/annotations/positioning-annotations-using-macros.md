...
* <a href="/advanced-chart-configurations/annotations/positioning-annotations-using-macros.html#annotation-macros">Annotation macros</a>

* <a href="/advanced-chart-configurations/annotations/positioning-annotations-using-macros.html#dynamic-positioning-using-macros">Dynamic positioning using macros with respect to the canvas, the dataset, and the axes</a>

* <a href="/advanced-chart-configurations/annotations/positioning-annotations-using-macros.html#annotation-macros-for-positioning-with-respect-to-other-chart-elements">Annotation Macros for positioning with respect to other chart elements</a>
