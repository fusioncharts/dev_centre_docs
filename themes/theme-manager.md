...
Refer to the [FusionCharts Suite XT Chart Attributes]({% site.baseurl %}/chart-attributes/?chart=area2d) page to better understand the objects and attributes used to configure the charts, gauges, and maps.
