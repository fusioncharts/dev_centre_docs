...
> There are different formats of JSON for different groups of charts in FusionCharts - e.g., single-series (which you're seeing here), [multi-series](https://www.fusioncharts.com/dev/chart-guide/standard-charts/multi-series-charts), [combination](https://www.fusioncharts.com/dev/chart-guide/standard-charts/combination-charts), etc.
...
For the detailed list of attributes, click [here](https://www.fusioncharts.com/dev/chart-attributes/?chart=area2d).
...
* To specify the data format as JSON, we have set the `dataFormat` parameter to json. You can also provide the data in [XML format](https://www.fusioncharts.com/dev/chart-guide/getting-started/using-xml-as-data-format). 
...
Now, go on and explore other 95+ chart types that we've in [FusionCharts](https://www.fusioncharts.com/dev/chart-guide/getting-started/list-of-charts) or explore the configuration [attribute](https://www.fusioncharts.com/dev/chart-attributes/?chart=area2d) for the charts.
...
See the complete list of[ all possible attributes](https://www.fusioncharts.com/dev/chart-attributes/?chart=angulargauge) for a angular gauge.
...
See the complete list of [all possible attributes](https://www.fusioncharts.com/dev/maps/attribute-reference) (the keys in the `dataSource` object) for the map of usa. A list of states of USA, and their respective `id`, can be found at [here](https://www.fusioncharts.com/dev/maps/spec-sheets/usa).
