...
<script type="text/javascript" src="js/themes/fusioncharts.theme.fusion.css"></script>
```
...
Step 2: Install the `vue-fusioncharts` wrapper framework via npm
...
### Step 3: Register the fusioncharts module
