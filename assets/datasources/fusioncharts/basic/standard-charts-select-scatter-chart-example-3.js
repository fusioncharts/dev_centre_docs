{
    ...
    events: {
        "beforeRender": function(evtObj, argObj) {
            ...
            controllers.innerHTML = "<div id='tableView-3' style='width:500px;display:none;margin-left:0px;max-height:250px;overflow:scroll;border: 1px solid #CCCCCC;margin: 3px;float: left;display:none; color: #666666;font-family:'Arial','Helvetica';font-size: 12px;'></div>";
            ...
            evtObj.sender.getDataFromChart = function() {
                var i,
                    ...
                    tableContainer = document.getElementById("tableView-3");
        ...
        "dataRestored": function(evtObj, argObj) {
            document.getElementById("tableView-3").style.display = "none";
            document.getElementById("tableView-3").innerHTML = "";
        }
    }
}
