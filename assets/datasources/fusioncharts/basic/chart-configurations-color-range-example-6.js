{
    ...
    "events": {
        "beforeRender": function(e, d) {
            ...
            e.sender.setJSONData(dataobj6.angulargauge);
            ...
            function instantiate() {
                ...
                function radioWrapper(wrapperId, inputId, label, selected, optionLabel) {
                    ...
                    item += "<input name='dimesion-selector-" + uniqueId + "'' id='" + inputId + "' type='radio' " + (selected ? "checked" : '') + " onchange='__onChange6(\"" + optionLabel + "\")'/>";
