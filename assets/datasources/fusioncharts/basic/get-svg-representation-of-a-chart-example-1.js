...
type: 'column2d',
    ...
    events: {
        'beforeRender': function(evt, args) {
            ...
            chartdata.style.cssText = 'backgound-color: #f0f0f0;border: #fff000 1px solid;margin: 10px;padding: 10px;font-size: 10px; max-height: 200px; overflow: auto';
            ...
            buttongetSVG.setAttribute('class', 'btn btn-transparent');
