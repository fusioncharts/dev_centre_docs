   ...
   events: {
      beforerender: function(evt, args) {
         ...
         controllers.innerHTML =
            '<div id="details" style=" width:260px;height:80px;border: 2px solid #ddd;margin-left: 160px"> <div style ="font-family:Arial;font-size: 15px;text-align:center;font-weight: bold;height:25px;border-bottom: 2px solid #ddd">Current Status</div><div id="data" style="font-family:Arial;font-size: 15px;text-align:center;font-weight: bold;padding-top:10px;color: #008ee4"></div></div>';
      ...
      rendered: function(evt, args) {
         ...
         evt.sender.chartInterval = setInterval(function() {
            var currDate, label, footfall, strData;
            /**
             * We need to create a querystring format incremental update,
             * containing label in hh:mm:ss format and a value (random).
             */
            currDate = new Date();
            label =
