{
    ...
    "events": {
         ...
         * @param {Object} dataObj: An object containing all the details related to the pointer being dragged, such as the pointer width and height, and so on.
         */

        "legendPointerDragStop": function(eventObj, dataObj) {
