...
* <a href="/gauge-and-widgets-guide/angular-gauge/logging-real-time-messages.html#setting-up-the-message-logger">Setup the message logger</a>

* <a href="/gauge-and-widgets-guide/angular-gauge/logging-real-time-messages.html#streaming-messages-using-the-message-logger">Stream messages using the message logger</a>

* <a href="/gauge-and-widgets-guide/angular-gauge/logging-real-time-messages.html#handling-messages-in-javascript">Handle messages using the JavaScript API</a>

* <a href="/gauge-and-widgets-guide/angular-gauge/logging-real-time-messages.html#configuring-the-message-logger-using-javascript-api">Configure the message logger using JavaScript API</a>
