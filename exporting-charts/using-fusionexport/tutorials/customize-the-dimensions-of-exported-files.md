...
3. [Export a Dashboard](https://www.fusioncharts.com/dev/exporting-charts/using-fusionexport/tutorials/export-a-dashboard)
...
After you have customized the dimensions, we recommend learning how to:
