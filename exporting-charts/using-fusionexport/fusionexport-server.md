...
To run FusionExport server from Docker, click [here](https://www.fusioncharts.com/dev/exporting-charts/using-fusionexport/installation/install-fusionexport-server#docker-6) for detailed installation setup.
...
Param Name|Default|Description|
-|-|-
stream_type||In this case where charts will be rendered and exported.
SVG / IMAGE-DATA|
stream|{}|In case of svg, it will contain the svg string
