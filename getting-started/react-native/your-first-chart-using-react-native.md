...
<div>
  ...
  <ul><li>Run the following command before generating the signed APK:</li></ul>
  <pre>
    <code class="language-javascript">
...
<ul style="margin-left:-10px"><li>Add a `build:assets` script in Application's package.json file</li></ul>
