...
Before going through this article, please [install]({% site.baseurl %}/getting-started/aspnet/install-using-aspnet) FusionCharts ASP.NET wrapper, if you haven’t installed it already.
