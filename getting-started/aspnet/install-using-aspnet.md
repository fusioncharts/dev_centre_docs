...
In order to install and start working with FusionCharts ASP.NET wrapper, you need to [download](https://www.fusioncharts.com/download/fusioncharts-suite) the FusionCharts Suite XT package which contains:
