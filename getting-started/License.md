# FusionCharts Software License Agreement – Perpetual License
...
Sl. 			No
		|			
Type 			of Retail License in Perpetual Model
		|			
No. 			of Developers allowed, within the same organization
		|			
Use 			in internal applications and websites (not including SaaS or OEM 			usage)
		|			
Transferrable 			between Developers within the company
		|			
Tenure 			of support and upgrades provided as part of perpetual license 			
		|			
...
1
		|			
1 			Developer License (Named Developer)
		|			
One 			(1) Developer
		|			
Permissible
...
Yes
		|			
Source 			code of all dashboards, Dashboard consulting, FusionExport License
		|
