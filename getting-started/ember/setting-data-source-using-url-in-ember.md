...
Let's build the same revenue chart which we built in the [first example]({% site.baseurl %}/getting-started/ember/your-first-chart-using-ember) using JSON, and use a .json file as the data source.
