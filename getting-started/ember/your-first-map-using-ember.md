...
- Set the map type as `world`. Each map is represented with a unique alias. For World Map, the alias is `world`. Find the complete list of maps with their respective alias [here](/map-guide/list-of-maps).
