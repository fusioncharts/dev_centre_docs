...
**Step 1:** Install the `vue-fusioncharts` module:

```PowerShell
$ npm install vue-fusioncharts --save
```

**Step 2:** Install `fusioncharts` library:
...
**Step 4:** Include the 'vue-fusioncharts' component:
