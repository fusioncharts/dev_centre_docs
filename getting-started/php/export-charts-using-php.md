...
description: This article focuses on how you can export your chart using php.
...
* [Export Charts as Image and PDF]({% site.baseurl %}/getting-started/php/export-charts-using-php#export-charts-as-image-and-pdf-1)
* [Modes of Export]({% site.baseurl %}/getting-started/php/export-charts-using-php#modes-of-export-2)
* [Export Chart Data]({% site.baseurl %}/getting-started/php/export-charts-using-php#export-chart-data-3)
