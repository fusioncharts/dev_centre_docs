...
In order to install and start working with PHP-FusionCharts you need to [download](https://www.fusioncharts.com/download/fusioncharts-suite) the FusionCharts Suite XT package which contains:
...
This completes the installation of FusionCharts in your application. To see how to create a chart, click [here]({% site.baseurl %}/getting-started/php/your-first-chart-using-php).
...
* JavaScript files to apply themes in the `js > themes` folder. click [here]({% site.baseurl %}/getting-started/php/your-first-chart-using-php#create-your-first-map-10).
