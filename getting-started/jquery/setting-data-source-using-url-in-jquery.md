...
Let's build the same revenue chart which we built in the [first example]({% site.baseurl %}/getting-started/jquery/your-first-chart-using-jquery) using JSON, and use a .json file as the data source.
