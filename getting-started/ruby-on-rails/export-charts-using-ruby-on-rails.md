...
* [Export Charts as Image and PDF](/getting-started/ruby-on-rails/export-charts-using-ruby-on-rails#export-charts-as-image-and-pdf-1)
* [Modes of Export](/getting-started/ruby-on-rails/export-charts-using-ruby-on-rails#modes-of-export-2)
* [Export Chart Data](/getting-started/ruby-on-rails/export-charts-using-ruby-on-rails#export-chart-data-3)
