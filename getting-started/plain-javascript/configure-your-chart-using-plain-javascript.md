---
permalink: getting-started/plain-javascript/configure-your-chart-using-plain-javascript.html
title: Configuring your Chart | FusionCharts
description: This article focuses on different type of configurations possible using the plain javascript.
