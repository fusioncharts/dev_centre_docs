...
Before going through this article, please [install]({% site.baseurl %}/getting-started/java/install-using-java) FusionCharts JSP wrapper, if you haven’t installed it already.
