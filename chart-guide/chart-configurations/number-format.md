...
Click [here](http://jsfiddle.net/fusioncharts/6w50wtfd/) to edit the above chart.
...
A column 2D chart with automatic number formatting looks like the one given above. The data for the chart is `12523, 14570.231, 17375` and `18235.79`. FusionCharts Suite XT automatically formats the number scaling by converting it to `K` and `M`.
...
Click [here](http://jsfiddle.net/fusioncharts/oupfaws8/) to edit the above chart.
