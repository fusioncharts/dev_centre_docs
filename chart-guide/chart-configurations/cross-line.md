---
title: Cross Line Configuration | FusionCharts Dev Centre
description: Cross line is a vertical line/area used as a quick reference for the data plots. The tooltip that appears is consolidated with all the information required.
heading: Cross Line
