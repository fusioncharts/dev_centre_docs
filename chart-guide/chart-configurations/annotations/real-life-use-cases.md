...
Click [here](https://www.fusioncharts.com/resources/) to see a collaborative dashboard that is a complex and practical example of how to use annotations, to add more information to a chart.
