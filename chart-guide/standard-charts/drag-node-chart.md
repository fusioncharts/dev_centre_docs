...
* From the bottom-left corner of the chart, click the <span> ![Drag-node-image](/images/standard-charts-drag-node-chart-connector-image-26.png)</span> option. A menu is rendered.
