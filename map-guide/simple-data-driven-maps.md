...
* Create an instance of the world map using its alias `maps/world`. Each map in FusionCharts Suite XT has a unique alias. You can find the list of all maps and their aliases [here]({% site.baseurl %}/chart-guide/getting-started/list-of-maps).
