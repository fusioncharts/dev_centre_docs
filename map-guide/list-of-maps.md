...
To render these maps, you need to download the map definition files from [here](https://cdn.fusioncharts.com/downloads/addons/fusionmaps-xt-definition.zip) and copy-paste the maps folder within your fusioncharts directory.
